...
We now register tools with the Registry but our code still has direct registration and tools in context. This likely have been reworked.
...
We'll correct this manually in a future step and we will elave things in place for now.